...
import { SECTOR_DEFINITIONS, type SectorDefinition } from '@/data/sectors';
import {
  getSectorImage,
...
function SectorCard({ sector }: { sector: SectorDefinition }) {
...
export default function SectorPlatformStrip() {
  return (
    <section className="home-sector-rail mt-2 overflow-hidden pt-0.5" aria-label="منصات القطاعات">
