        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, i) => (
              <div key={i} className="group rounded-2xl overflow-hidden border border-gold/15 hover:border-gold/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(201,168,76,0.1)]">
                {/* Image Placeholder */}
                ...
                <div className="p-6 bg-dark-lighter">
                  <h3 className="text-white font-bold text-xl mb-3 font-tajawal group-hover:text-gold-light transition-colors">
                    {project.title}
                  </h3>
                  <p className="text-white/60 text-sm leading-relaxed mb-4 font-tajawal">{project.description}</p>
                  <div className="flex items-center gap-6 text-white/50 text-xs font-tajawal">
