      ...
      <section className="py-16 md:py-24 bg-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-14">
            <p className="text-white/70 text-lg font-tajawal leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {teamMembers.map((member, i) => (
              <div key={i} className="group text-center p-6 rounded-2xl bg-white/5 border border-gold/10 hover:border-gold/30 transition-all duration-300 hover:shadow-[0_0_20px_rgba(201,168,76,0.1)]">
                {/* Avatar */}
                ...
                <p className="text-white/55 text-xs leading-relaxed font-tajawal">{member.description}</p>
              </div>
            ))}
          </div>
        </div>
