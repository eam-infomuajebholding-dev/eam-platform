...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark text-gray-900 dark:text-white font-tajawal transition-colors duration-300" dir="rtl">
      {/* Navigation */}
      <nav className="fixed top-0 right-0 left-0 z-50 bg-white/95 dark:bg-[#1a1a2e]/95 backdrop-blur-md border-b border-gold/20 transition-colors duration-300">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={toggleTheme}
              className="relative p-2 rounded-full bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 transition-all duration-300 group"
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white/98 dark:bg-[#1a1a2e]/98 backdrop-blur-md border-t border-gold/10 transition-colors duration-300">
