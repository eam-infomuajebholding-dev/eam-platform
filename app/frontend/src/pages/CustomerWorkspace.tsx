...
import { listServiceRequests } from '@/serviceRequests/serviceRequestClient';
import {
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="mb-8">
            ...
            <p className="mt-2 font-tajawal text-gray-600 dark:text-white/70">
              عرض حالة طلبات الخدمة المقدمة من رحلة بناء الفيلا.
            </p>
          </div>
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      ...
                      <h2 className="mt-1 text-lg font-bold font-tajawal text-gray-900 dark:text-white">
                    ...
                    <div className="text-left">
                      ...
                      <p className="mt-2 font-tajawal text-xs text-gray-500 dark:text-white/60">
