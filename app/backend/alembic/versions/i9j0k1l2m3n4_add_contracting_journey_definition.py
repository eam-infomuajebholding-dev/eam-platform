"""Add Contracting (#09) journey definition.
...
from services.jos_seed import CONTRACTING_WORKFLOW
...
def downgrade() -> None:
    op.execute(
        sa.text("UPDATE journey_definitions SET is_active = 0 WHERE journey_type = 'contracting'")
    )
