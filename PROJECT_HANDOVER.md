...
- **Upload Preset:** `your_cloud_name` (unsigned upload)
...
- **Endpoint:** `https://api.cloudinary.com/v1_1/your_cloud_name/auto/upload`
...
- [ ] Inventory all Cloudinary assets (note: cloud name `your_cloud_name`)
...
- **Cloud Name:** `your_cloud_name`
- **Upload Preset:** `your_cloud_name` (unsigned)
